  ...
  create(context) {
    ...
    return {
      Program() {
        ...
        const isValid = validSuffixes.some((suffix) =>
...
export default [
  ...
  // package.json - conventional field ordering
  {
    ...
    rules: {
      "jsonc/sort-keys": [
        ...
        {
          pathPattern:
            "^(?:dependencies|devDependencies|peerDependencies|optionalDependencies|bundleDependencies|overrides|resolutions)$",
          order: { type: "asc" },
        },
        {
          pathPattern: "^scripts$",
  ...
  {
    files: ["examples/**/*.json", "!examples/**/*.inputs.json"],
    plugins: jsoncPlugin,
    rules: {
      "jsonc/sort-keys": [
        "error",
        ...
        },
        {
          ...
          order: ["ns", "name", "params", "result", "body"],
        },
        {
          pathPattern: "^nodes\\[\\d+\\]$",
          order: ["id", "expr", "blocks", "entry"],
        },
        {
          pathPattern: ".",
          hasProperties: ["kind"],
